...
- 订阅：Pro 状态本地存储；购买页（月度/年度/永久买断）当前为演示激活，正式版接商店 IAP（Billing 依赖已加）
...
10. M5：同步页回环同步"双方 4 条数据一致"；订阅点击激活 Pro；v2→v3 迁移保留宝宝数据 ✅
...
- IAP 为演示激活，正式商店支付需接 Google Play Billing 回调 + 国内各商店 SDK，且需上架后真机验证
